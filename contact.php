    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center">
                <h1 class="mt-2 mb-5">Contacto para cualquier consulta</h1>
            </div>
            <div class="row">
                <div class="col-md-5">
                ...
                <div class="col-md-7">
                    <div class="contact-form">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="control-group">
                                <textarea class="form-control" rows="5" id="message" placeholder="Mesaje" required="required" data-validation-required-message="Please enter your message"></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div>
                                <button class="btn btn-primary font-weight-semi-bold px-4" style="height: 50px;" type="submit" id="sendMessageButton">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
