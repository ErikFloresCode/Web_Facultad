        ...
        <div class="container-lg p-0">
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand">
                    <h1 class="m-0 text-white display-4"><span class="text-primary">F</span>acultad de<span class="text-primary">C</span>iencias</h1>
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="investigacion.html" class="nav-item nav-link">Investigacion</a>
                        <a href="academico.html" class="nav-item nav-link">Academico</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Acceso</a>
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                <a href="#" class="dropdown-item">Docentes</a>
                                <a href="#" class="dropdown-item active">Estudiantes</a>
                            </div>
                        </div>
    ...
    <div class="container-fluid bg-secondary text-white mt-5 pt-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.html" class="navbar-brand">
                    <h1 class="m-0 mt-n2 text-white display-4"><span class="text-primary">U</span>S<span class="text-primary">F</span>X</h1>
                </a>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <h5 class="font-weight-bold text-primary mb-4">Donde contactarnos</h5>
